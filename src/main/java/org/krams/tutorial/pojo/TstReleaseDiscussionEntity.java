 ...
 */
@Entity
@Table(name = "TST_RELEASE_DISCUSSION", schema = "dbo", catalog = "SpiraTeam")
public class TstReleaseDiscussionEntity {
    ...
    public boolean equals(Object o) {
        ...
        TstReleaseDiscussionEntity that = (TstReleaseDiscussionEntity) o;
