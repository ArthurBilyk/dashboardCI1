 ...
 */
@Entity
@Table(name = "TST_REQUIREMENT_WORKFLOW_TRANSITION", schema = "dbo", catalog = "SpiraTeam")
public class TstRequirementWorkflowTransitionEntity {
    ...
    public boolean equals(Object o) {
        ...
        TstRequirementWorkflowTransitionEntity that = (TstRequirementWorkflowTransitionEntity) o;
