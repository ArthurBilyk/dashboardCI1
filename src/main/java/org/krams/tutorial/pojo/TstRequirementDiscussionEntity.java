 ...
 */
@Entity
@Table(name = "TST_REQUIREMENT_DISCUSSION", schema = "dbo", catalog = "SpiraTeam")
public class TstRequirementDiscussionEntity {
    ...
    public boolean equals(Object o) {
        ...
        TstRequirementDiscussionEntity that = (TstRequirementDiscussionEntity) o;
