 ...
 */
@Entity
@Table(name = "TST_TEST_SET_DISCUSSION", schema = "dbo", catalog = "SpiraTeam")
public class TstTestSetDiscussionEntity {
    ...
    public boolean equals(Object o) {
        ...
        TstTestSetDiscussionEntity that = (TstTestSetDiscussionEntity) o;
