 ...
 */
@Entity
@Table(name = "TST_TASK_WORKFLOW_TRANSITION_ROLE", schema = "dbo", catalog = "SpiraTeam")
@IdClass(TstTaskWorkflowTransitionRoleEntityPK.class)
public class TstTaskWorkflowTransitionRoleEntity {
    ...
    public boolean equals(Object o) {
        ...
        TstTaskWorkflowTransitionRoleEntity that = (TstTaskWorkflowTransitionRoleEntity) o;
