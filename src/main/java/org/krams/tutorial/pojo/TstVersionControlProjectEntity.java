 ...
 */
@Entity
@Table(name = "TST_VERSION_CONTROL_PROJECT", schema = "dbo", catalog = "SpiraTeam")
@IdClass(TstVersionControlProjectEntityPK.class)
public class TstVersionControlProjectEntity {
    ...
    @Basic
    @Column(name = "CONNECTION_STRING", nullable = true, insertable = true, updatable = true)
    ...
    public boolean equals(Object o) {
        ...
        TstVersionControlProjectEntity that = (TstVersionControlProjectEntity) o;
