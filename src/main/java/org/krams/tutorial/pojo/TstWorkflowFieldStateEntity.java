 ...
 */
@Entity
@Table(name = "TST_WORKFLOW_FIELD_STATE", schema = "dbo", catalog = "SpiraTeam")
public class TstWorkflowFieldStateEntity {
    ...
    public boolean equals(Object o) {
        ...
        TstWorkflowFieldStateEntity that = (TstWorkflowFieldStateEntity) o;
